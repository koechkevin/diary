...
class TestEntries(unittest.TestCase):
    ...
    def test_logout(self):
        t = app.test_client().get('/api/v2/entries/logout').status_code
        self.assertEqual(t, 422)
        te = app.test_client().get('/api/v2/entries/logou').status_code
    ...
    def test_modify_entry(self):
        modify = app.test_client().post('/api/v2/entries/modify_entry/3', json={}).status_code
